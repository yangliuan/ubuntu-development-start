...
# uninstall ubsoft use costom agruments
bash ${custom_dir}/setup/uninstall_devbase.sh -q --web --mysql --postgresql --mongodb --sqlite --redis --memcached --elastic_stack --allmq --allphp --pureftpd --supervisord --ffmpeg --nodejs_env --python_env --go_env --docker
