...
bash ${custom_dir}/setup/install_ubsoft.sh --input_method_option 2 --chrome --dingtalk --linuxqq --feishu --flameshot --indicator_sysmonitor --neteasy_cloudmusic --qqmusic --peek --qv2ray --theme_tools --bilibili_video_downloader --wps --custom --fceux
