...
bash ${custom_dir}/setup/install_ubsoft.sh --input_method_option 2 --chrome --dingtalk --linuxqq --feishu --flameshot --indicator_sysmonitor --neteasy_cloudmusic --qqmusic --peek --qv2ray --theme_tools --bilibili_video_downloader --wps --custom
...
# bash ${custom_dir}/setup/install_devtools.sh --openssh-server --switchhost --rdm --navicat_premium --mysql_workbench --terminal_net_tools --remmina --wireshark --postman --runapi --apifox --virtualbox --filezilla --jmeter --vscode --obs_studio --rabbitvcs_nautilus
