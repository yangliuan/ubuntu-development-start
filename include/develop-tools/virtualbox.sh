...
Install_Vbox(){
    ...
    dpkg -i virtualbox-${virtualbox_ver_base}_${virtualbox_ver_base}.${virtualbox_ver}-${virtualbox_ver_sn}~Ubuntu~eoan_amd64.deb
    apt install -f
    rm -rfv virtualbox-${virtualbox_ver_base}_${virtualbox_ver_base}.${virtualbox_ver}-${virtualbox_ver_sn}~Ubuntu~eoan_amd64.deb
